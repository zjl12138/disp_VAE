...
class VAEencoder(nn.Module):
    def __init__(self, cfg):
        ...
        # self.encoder_fc1 = nn.Linear(128*3, latent_num)
        # self.encoder_bn1 = nn.BatchNorm1d(latent_num)
        # self.encoder_fc2 = nn.Linear(128*3, latent_num)
    ...
    def forward(self, input_coordinates):
        ...
        z_mean = self.mean_relu(self.mean_bn(self.mean_fc(x))).view(batch_size, -1)  # B * (128 * 3)
